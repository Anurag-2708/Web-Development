    ...
    return <div className="editor personal-info-editor">
        ...
        <form>
            ...
            <div className="form-group">
                ...
                <input type="email" id="email" name="email" placeholder='youremail@exmaple.com' required
                    onChange={e => infoSetters.setEmailID(e.target.value)} />
            </div>

            <div className="form-group">
                <label htmlFor="LinkedInID">LinkedIn Username</label>
                <input type="text" id="LinkedInID" name="LinkedInID" placeholder='john-smith'
            ...
            <div className="form-group">
                ...
                <input type="text" id="GitHubID" name="GitHubID" placeholder='john-smith-1999'
